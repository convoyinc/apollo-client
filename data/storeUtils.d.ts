...
export declare type StoreValue = number | string | string[] | IdValue | ListValue | JsonValue | null | undefined | void;
export interface QueryCache {
    [queryId: string]: QueryCacheValue;
}
export declare type QueryCacheState = 'fresh' | 'stale' | 'dirty';
