...
export declare class QueryManager {
    ...
    private queryListenerWatchCancel;
    private queryListenerInvalidated;
    ...
    constructor({networkInterface, reducerConfig, fragmentMatcher, addTypename, queryDeduplication, ssrMode, initialCache, onBroadcast}: {
        networkInterface: NetworkInterface;
    ...
    addQueryListener(queryId: string, listener: QueryListener, options: WatchQueryOptions): void;
