...
var QueryManager = (function () {
    ...
    QueryManager.prototype.getCurrentQueryResult = function (observableQuery, isOptimistic) {
        ...
        var partial = true;
        try {
            data = readFromStore_1.readQueryFromStore(readOptions);
            partial = false;
        }
        catch (e) {
        ...
        var transformed = this.transformResult({ data: data, loading: false, networkStatus: null });
        return { data: transformed.data, partial: partial };
    };
