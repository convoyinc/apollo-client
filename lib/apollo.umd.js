(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('graphql-tag/printer'), require('redux'), require('symbol-observable'), require('graphql-anywhere')) :
    typeof define === 'function' && define.amd ? define(['exports', 'graphql-tag/printer', 'redux', 'symbol-observable', 'graphql-anywhere'], factory) :
    (factory((global.apollo = global.apollo || {}),global.graphqlTag_printer,global.redux,global.$$observable,global.graphqlAnywhere));
}(this, (function (exports,graphqlTag_printer,redux,$$observable,graphqlAnywhere) { 'use strict';
