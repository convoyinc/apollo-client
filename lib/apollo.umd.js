...
var QueryManager = (function () {
    ...
    QueryManager.prototype.getCurrentQueryResult = function (observableQuery, isOptimistic) {
        ...
        var transformed = this.transformResult({ data: data, loading: false, networkStatus: exports.NetworkStatus.ready });
        return maybeDeepFreeze({ data: transformed.data, partial: partial });
    };
