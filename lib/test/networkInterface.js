...
describe('network interface', function () {
    ...
    before(function () {
        fetchMock.post(swapiUrl, function (url, opts) {
            ...
            if (query === printer_1.print(simpleQueryWithNoVars)) {
                return simpleResult;
            }
            if (query === printer_1.print(simpleQueryWithVar)
                && isequal(variables, { personNum: 1 })) {
                return simpleResult;
            }
            if (query === printer_1.print(complexQueryWithTwoVars)
    ...
    describe('creating a network interface', function () {
        ...
        it('should throw without an endpoint', function () {
            assert.throws(function () {
                networkInterface_1.createNetworkInterface({});
        ...
        it('should create an instance with a given uri', function () {
            var networkInterface = networkInterface_1.createNetworkInterface({ uri: '/graphql' });
        ...
        it('should allow for storing of custom options', function () {
            ...
            var networkInterface = networkInterface_1.createNetworkInterface({ uri: '/graphql', opts: customOpts });
    ...
    describe('middleware', function () {
        ...
        it('should alter the request variables', function () {
            ...
            var swapi = networkInterface_1.createNetworkInterface({ uri: swapiUrl });
            swapi.use([testWare1]);
            var simpleRequest = {
        ...
        it('should alter the request body params', function () {
            ...
            var swapi = networkInterface_1.createNetworkInterface({ uri: 'http://graphql-swapi.test/' });
            swapi.use([testWare1]);
            var simpleRequest = {
                query: simpleQueryWithVar,
        ...
        it('should chain use() and useAfter() calls', function () {
            ...
            var networkInterface = networkInterface_1.createNetworkInterface({ uri: swapiUrl });
    ...
    describe('making a request', function () {
        ...
        it('should throw on a network error', function () {
            var nowhere = networkInterface_1.createNetworkInterface({ uri: missingUrl });
            var doomedToFail = {
                query: simpleQueryWithNoVars,
                variables: {},
                debugName: 'People Query',
