...
describe('query transforms', function () {
    it('should correctly add typenames', function () {
        ...
        var newQueryDoc = queryTransform_1.applyTransformers(testQuery, [queryTransform_1.addTypenameToSelectionSet]);
    ...
    it('should correctly add custom fields', function () {
        var testQuery = (_a = ["\n      query {\n        author {\n          name {\n            firstName\n            lastName\n          }\n        }\n      }\n    "], _a.raw = ["\n      query {\n        author {\n          name {\n            firstName\n            lastName\n          }\n        }\n      }\n    "], graphql_tag_1.default(_a));
        function addBirthdayField(selectionSet) {
            return queryTransform_1.addFieldToSelectionSet('birthday', selectionSet);
        }
        var newQueryDoc = queryTransform_1.applyTransformers(testQuery, [addBirthdayField]);
        var queryDef = getFromAST_1.getQueryDefinition(newQueryDoc);
        var modifiedQueryStr = printer_1.print(queryDef);
        var expectedQuery = getFromAST_1.getQueryDefinition((_b = ["\n      query {\n        author {\n          name {\n            firstName\n            lastName\n            birthday\n          }\n          birthday\n        }\n      }\n    "], _b.raw = ["\n      query {\n        author {\n          name {\n            firstName\n            lastName\n            birthday\n          }\n          birthday\n        }\n      }\n    "], graphql_tag_1.default(_b)));
        var expectedQueryStr = printer_1.print(expectedQuery);
        chai_1.assert.equal(expectedQueryStr, modifiedQueryStr);
        var _a, _b;
    });
    ...
    it('should not screw up on a FragmentSpread within the query AST', function () {
        var testQuery = (_a = ["\n    query withFragments {\n      user(id: 4) {\n        friends(first: 10) {\n          ...friendFields\n        }\n      }\n    }"], _a.raw = ["\n    query withFragments {\n      user(id: 4) {\n        friends(first: 10) {\n          ...friendFields\n        }\n      }\n    }"], graphql_tag_1.default(_a));
        var expectedQuery = getFromAST_1.getQueryDefinition((_b = ["\n    query withFragments {\n      user(id: 4) {\n        friends(first: 10) {\n          ...friendFields\n          __typename\n        }\n        __typename\n      }\n    }\n    "], _b.raw = ["\n    query withFragments {\n      user(id: 4) {\n        friends(first: 10) {\n          ...friendFields\n          __typename\n        }\n        __typename\n      }\n    }\n    "], graphql_tag_1.default(_b)));
        var modifiedQuery = queryTransform_1.applyTransformers(testQuery, [queryTransform_1.addTypenameToSelectionSet]);
    ...
    it('should be able to apply multiple transformers', function () {
        var testQuery = (_a = ["\n    query withFragments {\n      user(id: 4) {\n        friends(first: 10) {\n          ...friendFields\n        }\n      }\n    }\n    fragment friendFields on User {\n      firstName\n      lastName\n    }"], _a.raw = ["\n    query withFragments {\n      user(id: 4) {\n        friends(first: 10) {\n          ...friendFields\n        }\n      }\n    }\n    fragment friendFields on User {\n      firstName\n      lastName\n    }"], graphql_tag_1.default(_a));
        function addBirthdayField(selectionSet) {
            return queryTransform_1.addFieldToSelectionSet('birthday', selectionSet);
        }
        var newQueryDoc = queryTransform_1.applyTransformers(testQuery, [queryTransform_1.addTypenameToSelectionSet, addBirthdayField]);
        var expectedQuery = (_b = ["\n    query withFragments {\n      user(id: 4) {\n        friends(first: 10) {\n          ...friendFields\n          __typename\n          birthday\n        }\n        __typename\n        birthday\n      }\n    }\n    fragment friendFields on User {\n      firstName\n      lastName\n      __typename\n      birthday\n    }"], _b.raw = ["\n    query withFragments {\n      user(id: 4) {\n        friends(first: 10) {\n          ...friendFields\n          __typename\n          birthday\n        }\n        __typename\n        birthday\n      }\n    }\n    fragment friendFields on User {\n      firstName\n      lastName\n      __typename\n      birthday\n    }"], graphql_tag_1.default(_b));
        chai_1.assert.equal(printer_1.print(expectedQuery), printer_1.print(newQueryDoc));
        var _a, _b;
    });
