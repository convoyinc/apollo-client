        ...
        describe('with `updateQueries`', function () {
            ...
            it('handles a single error for a single mutation', function () {
                return setup({
                    ...
                    var dataInStore = client.queryManager.dataStore.getCache().getOptimisticData();
        ...
        it('two array insert like mutations', function () {
            ...
            return setup({
                ...
                var promise = client
                    ...
                    .then(function (res) {
                    var currentDataInStore = client.queryManager.dataStore.getCache().getOptimisticData();
