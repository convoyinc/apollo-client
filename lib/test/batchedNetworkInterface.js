...
describe('HTTPBatchedNetworkInterface', function () {
    var assertRoundtrip = function (_a) {
        ...
        return batchedNetworkInterface
            .batchQuery(requestResultPairs.map(function (_a) {
    ...
    describe('errors', function () {
        ...
        it('should throw an error with the response when a non-200 response is received', function (done) {
            var fakeForbiddenResponse = createMockedIResponse([], {
                status: 401,
    ...
    describe('transforming queries', function () {
        it('should remove the @connection directive', function () {
            var authorQueryWithConnection = (_a = ["\n        query {\n          author @connection(key: \"author\") {\n            firstName\n            lastName\n          }\n        }\n      "], _a.raw = ["\n        query {\n          author @connection(key: \"author\") {\n            firstName\n            lastName\n          }\n        }\n      "], gql(_a));
            var url = 'http://fake.com/graphql';
            var batchedNetworkInterface = new HTTPBatchedNetworkInterface({
                uri: url,
                batchInterval: 10,
