...
describe('client', function () {
    it('does not require any arguments and creates query manager lazily', function () {
    ...
    it('should allow a single query with an apollo-link enabled network interface', function (done) {
        var query = (_a = ["\n      query people {\n        allPeople(first: 1) {\n          people {\n            name\n            __typename\n          }\n          __typename\n        }\n      }\n    "], _a.raw = ["\n      query people {\n        allPeople(first: 1) {\n          people {\n            name\n            __typename\n          }\n          __typename\n        }\n      }\n    "], gql(_a));
        var data = {
            allPeople: {
                people: [
        ...
        var networkInterface = ApolloLink.from([
            function () {
    ...
    it('should allow for a single query with default values that get overridden with variables', function () {
        ...
        var withOverride = client
            .query({ query: query, variables: override })
    ...
    it('store can be rehydrated from the server', function () {
        ...
        var finalState = assign({}, initialState, {});
        var client = new ApolloClient({
            networkInterface: networkInterface,
            initialState: initialState,
            addTypename: false,
        });
        return client.query({ query: query }).then(function (result) {
            assert.deepEqual(result.data, data);
            assert.deepEqual(finalState.data, client.queryManager.dataStore.getCache().getData());
        });
        var _a;
    });
    it('should return errors correctly for a single query', function () {
        ...
        return client.query({ query: query }).catch(function (error) {
            assert.deepEqual(error.graphQLErrors, errors);
        });
        var _a;
    });
    it('should return GraphQL errors correctly for a single query with an apollo-link enabled network interface', function (done) {
        var query = (_a = ["\n      query people {\n        allPeople(first: 1) {\n          people {\n            name\n          }\n        }\n      }\n    "], _a.raw = ["\n      query people {\n        allPeople(first: 1) {\n          people {\n            name\n          }\n        }\n      }\n    "], gql(_a));
        var data = {
            allPeople: {
                people: [
        ...
        client.query({ query: query }).catch(function (error) {
            assert.deepEqual(error.graphQLErrors, errors);
            done();
        });
        var _a;
    });
    it('should pass a network error correctly on a query using an observable network interface with a warning', function (done) {
    ...
    it('should pass a network error correctly on a query with apollo-link network interface', function (done) {
        var query = (_a = ["\n      query people {\n        allPeople(first: 1) {\n          people {\n            name\n          }\n        }\n      }\n    "], _a.raw = ["\n      query people {\n        allPeople(first: 1) {\n          people {\n            name\n          }\n        }\n      }\n    "], gql(_a));
        var data = {
            person: {
                firstName: 'John',
    ...
    it('should warn when receiving multiple results from apollo-link network interface', function () {
        var query = (_a = ["\n      query people {\n        allPeople(first: 1) {\n          people {\n            name\n          }\n        }\n      }\n    "], _a.raw = ["\n      query people {\n        allPeople(first: 1) {\n          people {\n            name\n          }\n        }\n      }\n    "], gql(_a));
        var data = {
            allPeople: {
                people: [
        ...
        var networkInterface = ApolloLink.from([
            function () { return Observable.of({ data: data }, { data: data }); },
        ]);
        var client = new ApolloClient({
            networkInterface: networkInterface,
            addTypename: false,
    ...
    it('should call updateQueries and update after mutation on query with inlined fragments on an Interface type', function (done) {
        var query = (_a = ["\n      query items {\n        items {\n          ...ItemFragment\n          __typename\n        }\n      }\n\n      fragment ItemFragment on Item {\n        id\n        ... on ColorItem {\n          color\n          __typename\n        }\n        __typename\n      }\n    "], _a.raw = ["\n      query items {\n        items {\n          ...ItemFragment\n          __typename\n        }\n      }\n\n      fragment ItemFragment on Item {\n        id\n        ... on ColorItem {\n          color\n          __typename\n        }\n        __typename\n      }\n    "], gql(_a));
        var result = {
            items: [
                {
        ...
        var obs = client.watchQuery({ query: query });
        var sub = obs.subscribe({
            next: function () {
                client
                    .mutate({ mutation: mutation, updateQueries: updateQueries, update: updateSpy })
                    .then(function () {
    ...
    describe('accepts dataIdFromObject option', function () {
        ...
        it('for internal store', function () {
            ...
            return client.query({ query: query }).then(function (result) {
                assert.deepEqual(result.data, data);
                assert.deepEqual(client.queryManager.dataStore.getCache().getData()['1'], {
                    id: '1',
                    name: 'Luke Skywalker',
                });
            });
    ...
    it('should rollback optimistic after mutation got a GraphQL error', function (done) {
        ...
        assert.equal(client.queryManager.dataStore.getCache().optimistic.length, 1);
        mutatePromise
            .then(function (result) {
            done(new Error('Returned a result when it should not have.'));
        })
            .catch(function (error) {
            assert.equal(client.queryManager.dataStore.getCache().optimistic.length, 0);
            done();
        });
        var _a;
    });
    ...
    it('should enable dev tools logging', function () {
        ...
        it('with self-made store', function () {
            ...
            return client.query({ query: query }).then(function () {
