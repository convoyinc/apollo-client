...
export declare function diffQueryAgainstStore({store, query, variables, previousResult, returnPartialData, rootId, fragmentMatcherFunction, config, queryCache, queryId, allowModifiedQueryCache, returnOnlyQueryCacheData}: DiffQueryAgainstStoreOptions): DiffResult;
