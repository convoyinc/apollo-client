(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('whatwg-fetch'), require('graphql/language/printer'), require('redux'), require('lodash'), require('graphql-anywhere'), require('symbol-observable')) :
	typeof define === 'function' && define.amd ? define(['exports', 'whatwg-fetch', 'graphql/language/printer', 'redux', 'lodash', 'graphql-anywhere', 'symbol-observable'], factory) :
	(factory((global.apollo = global.apollo || {}),null,global.graphql_language_printer,global.redux,global.lodash,global.graphqlAnywhere,global.$$observable));
}(this, (function (exports,whatwgFetch,graphql_language_printer,redux,lodash,graphqlAnywhere,$$observable) { 'use strict';
...
function diffQueryAgainstStore(_a) {
    var store = _a.store, query = _a.query, variables = _a.variables, previousResult = _a.previousResult, _b = _a.returnPartialData, returnPartialData = _b === void 0 ? true : _b, _c = _a.rootId, rootId = _c === void 0 ? 'ROOT_QUERY' : _c, fragmentMatcherFunction = _a.fragmentMatcherFunction, config = _a.config, queryCache = _a.queryCache, queryId = _a.queryId, allowModifiedQueryCache = _a.allowModifiedQueryCache, _d = _a.returnOnlyQueryCacheData, returnOnlyQueryCacheData = _d === void 0 ? false : _d;
    var queryDefinition = getQueryDefinition(query);
    variables = assign({}, getDefaultValues(queryDefinition), variables);
    if (queryId && queryCache) {
        var _e = readQueryFromCache({ queryId: queryId, queryCache: queryCache, variables: variables, allowModified: allowModifiedQueryCache }), result_1 = _e.result, modified = _e.modified;
        if (result_1) {
            return {
                result: result_1,
                isMissing: false,
    ...
    QueryManager.prototype.fetchQuery = function (queryId, options, fetchType, fetchMoreForQueryId) {
        ...
        if ((fetchType !== FetchType.refetch && fetchPolicy !== 'network-only')) {
            ...
            var _d = diffQueryAgainstStore({
                ...
                queryCache: cache.queryCache,
                queryId: queryId,
            }), isMissing = _d.isMissing, result = _d.result, wasCached = _d.wasCached, queryCacheKeys = _d.queryCacheKeys;
